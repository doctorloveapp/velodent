...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::quote_care_alert,
            commands::update_quote_with_new_records,
            commands::ignore_quote_new_records,
            commands::snooze_quote_new_records_reminder,
            commands::revise_quote,
            commands::close_quote,
            ...
            commands::mark_clinical_record_performed,
